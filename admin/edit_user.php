                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href = "registeredusers.php"  class = "btn btn-danger btn-sm float-right ">Back</a>  
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                                ...
                                                if(isset($_GET['user_id'])){
                                                    ...
                                                    if(mysqli_num_rows($query_run) > 0){
                                                        foreach($query_run as $row){
                                                            ?>
                                                        <div><input type="hidden" name="user_id" value="<?php echo $row['id'] ?>"</div> 
                                                            <div class="form-group">
                                                                <label for="">Name</label>
                                                                <input type="text" name = "name" value= "<?php echo $row['name'] ?>" class="form-control" placeholder="Email">
                                                            </div>
                                                            <div class="form-group">
